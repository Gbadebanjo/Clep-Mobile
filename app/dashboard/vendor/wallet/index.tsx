...
const WalletDashboard = () => {
  const [activeTab, setActiveTab] = useState<'Recent' | 'Escrow credit' | 'Withdrawal'>('Recent');
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <FlatList
        ...
        ListEmptyComponent={<ThemedText style={styles.empty}>No transactions found</ThemedText>}
